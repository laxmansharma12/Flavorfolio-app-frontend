...
const ChineseRecipesContainer = styled.div`
	width: 100%;
...
const ChineseRecipesInnerContainer = styled.div`
	display: flex;
	flex-direction: row;
	flex-wrap: wrap;
	...
	return (
		<Layout title={"ChinseseRecipes"}>
			<ChineseRecipesContainer>
				...
				<L>
					Chinese cuisine is a harmonious blend of flavors that engage the mind
					and palate.
				</L>
				<ChineseRecipesInnerContainer>
					<>
						{auth?.user ? (
							<>
